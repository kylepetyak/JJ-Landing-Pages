...
const content = getContent("isnetworld")!;

export const metadata: Metadata = {
  title: `${content.trademark} Certification Services`,
  description: `Get ${content.trademark} certified fast. ${content.hero.subheadline}`,
  openGraph: {
    title: `${content.trademark} Certification Services | JJ Safety`,
    description: `Get ${content.trademark} certified fast. ${content.hero.subheadline}`,
  },
};

/**
 * ISNetworld Landing Page
 *
 ...
 */
export default function ISNetworldPage() {
  return (
